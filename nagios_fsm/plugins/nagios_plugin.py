...
try:
    ...
    parser.add_option("-H", "--hostname", default="segarra", dest="hostname", help="name of pool master")
    parser.add_option("-l", "--login-name", default="root", dest="username", help="name to log in as (usually root)")
    parser.add_option("-p", "--password", default="uoc123", dest="password", help="password")
