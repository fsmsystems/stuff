...
PS1="$sq_color\342\224\214\342\224\200\$([[ \$? != 0 ]] && echo \"[\[\033[01;37m\]\342\234\227$sq_color]\342\224\200\")[\[\033[01;37m\]\t$sq_color]\342\224\200[\[\033[01;37m\]\u@\h$sq_color]\n\342\224\224\342\224\200\342\224\200> \[\033[01;32m\]\W$sq_color $ \[\033[01;34m\]>>\\[\\033[0m\\] "
...
alias chroxy='chromium-browser --no-first-run --user-data-dir=/tmp/$(date +%F_%H:%M:%S:%N) --proxy-server="localhost:8080"'
alias chromium_tmp='chromium-browser --no-first-run --user-data-dir=/tmp/$(date +%F_%H:%M:%S:%N)'
alias top='htop'
...
alias txt='vim /home/ferran/Dropbox/IT/txt'
alias searchci='python /home/ferran/cmdb-utils/searchci.py'
